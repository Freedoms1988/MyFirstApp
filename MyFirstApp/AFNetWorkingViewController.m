...
#define CGRECT_TEXTFIELD CGRectMake(10.0f,10.0f,140.0f,44.0f)
#define CGRECT_BUTTON CGRectMake(160.0f,10.0f,140.0f,44.0f)
#define CGRECT_TABLEVIEW CGRectMake(0.0f, 55.0f, 320.0f, 460.0f)

//#define URL @"http://www.weather.com.cn/data/sk/101010100.html"
#define MAIN @"http://www.weather.com.cn/data/sk/"
...
-(void) initData
{
    ...
    [_weatherKeysDict setObject:@"--" forKey:@"WSE"];
    [_weatherKeysDict setObject:@"--" forKey:@"isRadar"];
    [_weatherKeysDict setObject:@"--" forKey:@"Radar"];
...
-(void) initUIView
{
    ...
    _sendButton.frame = CGRECT_BUTTON;
    [_sendButton setTitle:@"TEST" forState:UIControlStateNormal];
    [_sendButton addTarget:self action:@selector(sendRequest) forControlEvents:UIControlEventTouchUpInside];
...
-(void)sendRequest
{
    ...
    NSURL *url = [NSURL URLWithString:[[MAIN stringByAppendingString:[_citysDict objectForKey:[_cityTextfield text]]] stringByAppendingString:@".html"]];
